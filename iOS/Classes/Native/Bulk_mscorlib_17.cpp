...
IL_007a:
	...
	}
	{
		...
		NullCheck(L_31);
		TypeU5BU5D_t3940880105* L_32 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(101 /* System.Type[] System.Type::GetGenericArguments() */, L_31);
...
IL_0073:
	{
		...
		NullCheck(L_11);
		Type_t * L_13 = VirtFuncInvoker1< Type_t *, TypeU5BU5D_t3940880105* >::Invoke(97 /* System.Type System.Type::MakeGenericType(System.Type[]) */, L_11, L_12);
...
IL_00ce:
	{
		...
		NullCheck(L_26);
		TypeU5BU5D_t3940880105* L_27 = VirtFuncInvoker0< TypeU5BU5D_t3940880105* >::Invoke(101 /* System.Type[] System.Type::GetGenericArguments() */, L_26);
